...
<div v-for="(cars, city) in groupedCars" :key="city">
  <div class="titulo">
    <h2>Autos en {{ city }}</h2>
  </div>
  <div class="car-grid">
    <div v-for="car in cars" :key="car.name" class="car">
      <router-link :to="'/Auto_ordenar/' ">
...
import { useCountryStore } from '../../../../../../../Agencia_Oasis-1/SIS213Oasis/FrontendOasis/src/store/country';
import { Car } from '../../../../../../../Agencia_Oasis-1/SIS213Oasis/FrontendOasis/src/data/data';
...
export default defineComponent({
  ...
  setup() {
    ...
    const cars = computed(() => countryStore.cars);
