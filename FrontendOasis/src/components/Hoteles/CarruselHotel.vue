...
<template>
  ...
  const images = [
    { Image: 'src/assets/hotel/hotel17.jpg', alt: '', author: 'OASIS', title: 'Alvear Palace Hotel', topic: 'ARGENTINA', des: '' },
    { src: 'src/assets/hotel/hotel18.jpg', alt: '', author: 'OASIS', title: 'Baruk Hotel de Autor', topic: 'MEXICO', des: '' },
    { src: 'src/assets/hotel/hotel19.jpg', alt: '', author: 'OASIS', title: 'Four Seasons México City', topic: 'MEXICO', des: '' },
    { src: 'src/assets/hotel/hotel20.jpg', alt: '', author: 'OASIS', title: 'Gran Hotel Costa Rica, Curio Collection by Hilton', topic: 'COSTA RICA', des: '' },
  ];
  
  const thumbnails = [
    { src: 'src/assets/hotel/hotel17.jpg', alt: 'Thumb1', title: 'Alvear Palace Hotel', des: 'Descripcion' },
    { src: 'src/assets/hotel/hotel18.jpg', alt: 'Thumb2', title: 'Baruk Hotel de Autor', des: 'Descripcion' },
    { src: 'src/assets/hotel/hotel19.jpg', alt: 'Thumb3', title: 'Four Seasons México City', des: 'Descripcion' },
    { src: 'src/assets/hotel/hotel20.jpg', alt: 'Thumb4', title: 'Gran Hotel Costa Rica, Curio Collection by Hilton', des: 'Descripcion' },
  ];
