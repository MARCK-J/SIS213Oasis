<template>
    ...
    <div class="product-description-grid">
      <div class="description">
        ...
        <p>
          Sumerville All Inclusive Resort es un lugar paradisiaco situado en las hermosas playas de Brasil. Ofrece a sus visitantes una experiencia única con todos los servicios incluidos, para que solo se preocupen por disfrutar de sus vacaciones. Este resort cuenta con instalaciones de primera clase, piscinas impresionantes, restaurantes gourmet, actividades para toda la familia y un servicio de atención al cliente excepcional.
        </p>
      </div>
  ...
  export default {
    data() {
      return {
        ...
        showCities: false,
        images: [
          'src/assets/hotel/sumerville3.jpg',
          'src/assets/hotel/sumerville2.jpg',
          'src/assets/hotel/sumerville3.jpg',
          'src/assets/hotel/sumerville4.jpg',
        ],
        currentImageIndex: 0,
        map: null, 
        services: [
